...
use Xatoma\SteamCommunity\User\Chat;
use Xatoma\SteamCommunity\SteamException;
use Xatoma\SteamCommunity\Enum\CreateAccountResult;
use Xatoma\SteamCommunity\Enum\LoginResult;
use Xatoma\SteamCommunity\Auth\MobileAuth;
...
class SteamCommunity
{
    ...
    {
        $namespaceClass = 'Xatoma\\SteamCommunity\\' . $class;
